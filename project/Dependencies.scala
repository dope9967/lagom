...
object Dependencies {
  object Versions {
    ...
    val Akka: String = sys.props.getOrElse("lagom.build.akka.version", "2.6.4-persistence-typed-idempotence") // sync with docs/build.sbt
    val AkkaHttp     = "10.1.11"

    val AkkaPersistenceCassandra = "0.103-persistence-typed-idempotence"
  ...
  val ow2asmDeps = libraryFamily("org.ow2.asm", "7.2")(
    "asm",
    "asm-analysis",
    "asm-commons",
    "asm-tree",
